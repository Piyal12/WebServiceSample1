...
public class GetCreditApplicationDetailsByIdTest extends TestBase
{
    ...
    @Test(enabled = true, dataProviderClass = TestDataProvider.class, dataProvider = "TestDataGenerator",groups = {"positive","sanity","regression"},description ="Get credit application details by ID")
    ...
    public void credit_application_details_id_test(HashMap<String, String> data) throws Exception
    {
        WebService rest = Ws.get(ServiceGroup.CREDIT, GetCreditApplicationDetailsByIdTest.SERVICE_NAME, TestBase.ENV,data);
        ...
        Assert.assertTrue(rest.getResponse().body().jsonPath().getBoolean("success"), "Getting Credit details by ID failed");
