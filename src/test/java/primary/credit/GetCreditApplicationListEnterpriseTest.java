...
public class GetCreditApplicationListEnterpriseTest extends TestBase
{
    ...
    @Test(enabled = true, dataProviderClass = TestDataProvider.class, dataProvider = "TestDataGenerator",groups = {"positive","sanity","regression"},description ="Get credit application list for Enterprise")
    ...
    public void credit_list_enterprise_test(HashMap<String, String> data) throws Exception
    {
