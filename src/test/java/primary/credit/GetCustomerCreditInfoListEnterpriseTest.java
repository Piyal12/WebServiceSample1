...
public class GetCustomerCreditInfoListEnterpriseTest extends TestBase
{
    ...
    @Test(enabled = true, dataProviderClass = TestDataProvider.class, dataProvider = "TestDataGenerator",groups = {"positive","sanity","regression"},description ="Get customer credit info list for Enterprise")
    ...
    public void customer_credit_info_list_enterprise_test(HashMap<String, String> data) throws Exception
    {
