...
public class CreateCreditApplicationRetailTest extends TestBase
{
    ...
    @Test(enabled=true, dataProviderClass= TestDataProvider.class, dataProvider="TestDataGenerator",groups = {"positive","sanity","regression"},description ="Create credit application for Retail")
    ...
    public void credit_application_retail_test (HashMap<String, String> data) throws Exception
    {
        ...
        Assert.assertTrue(rest.getResponse().body().jsonPath().getBoolean("success") , "Credit application retail failed");
