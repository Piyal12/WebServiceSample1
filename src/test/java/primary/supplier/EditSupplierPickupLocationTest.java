...
public class EditSupplierPickupLocationTest extends TestBase {
	...
	@Test (enabled=true, dataProviderClass=TestDataProvider.class, dataProvider="TestDataGenerator",groups = {"regression","sanity","positive"},description = "EditSupplierPickupLocationTest with all valid params")
	...
	public void editSupplierLocnTest (HashMap <String, String> data){
		...
		Assert.assertTrue(rest.getResponse().body().jsonPath().getBoolean("success") , "EditSupplierLocation failed ");
