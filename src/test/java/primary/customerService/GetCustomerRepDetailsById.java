 ...
 * @author Dharini H M
 */
public class GetCustomerRepDetailsById extends TestBase{
    ...
    @Annotation.TestRun(serviceGroup = ServiceGroup.CUSTOMER, serviceName = GetCustomerRepDetailsById.SERVICE_NAME, testName = "GetCustomerRepDetailsById", testGroup = "p0")
    public void GetCustomerRepDetailsByIdListTest(HashMap<String, String> data) throws Exception {
        WebService rest = Ws.get(ServiceGroup.CUSTOMER, GetCustomerRepDetailsById.SERVICE_NAME, TestBase.ENV,data);
